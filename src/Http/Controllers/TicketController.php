...
class TicketController extends Controller
{
    ...
    {
        $this->model = \TomatoPHP\TomatoSupport\Models\Ticket::class;
    }
    ...
    public function index(Request $request): View|JsonResponse
    {
        ...
        return Tomato::index(
            ...
            table: \TomatoPHP\TomatoSupport\Tables\TicketTable::class,
            filters: [
                'accountable_type',
                'accountable_id',
            ],
    ...
    public function api(Request $request): JsonResponse
    {
        return Tomato::json(
            request: $request,
            model: \TomatoPHP\TomatoSupport\Models\Ticket::class,
        );
    }
     ...
     *
     * @param \TomatoPHP\TomatoSupport\Models\Ticket $model
     * @return View|JsonResponse
     */
    public function show($model): View|JsonResponse
    {
        $model = \TomatoPHP\TomatoSupport\Models\Ticket::find($model);
        return Tomato::get(
            model: $model,
     ...
     * @return View
     */
    public function edit(\TomatoPHP\TomatoSupport\Models\Ticket $model): View
    {
        return Tomato::get(
            model: $model,
     ...
     * @return RedirectResponse|JsonResponse
     */
    public function update(Request $request, \TomatoPHP\TomatoSupport\Models\Ticket $model): RedirectResponse|JsonResponse
    {
     ...
     * @return RedirectResponse|JsonResponse
     */
    public function destroy(\TomatoPHP\TomatoSupport\Models\Ticket $model): RedirectResponse|JsonResponse
    {
     ...
     */
    public function comments(\TomatoPHP\TomatoSupport\Models\Ticket $model){
